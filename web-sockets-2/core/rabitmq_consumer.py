...
from redis_utils import get_user_active_chat_room
...
#         user_payload = json.loads(message)
#         logging.info(f"Received message: {user_payload}")
#         print("Received message: ___________ WEBSOCKET SERVER 3", user_payload)
...
#                         active_room = await get_user_active_chat_room(target_user_id)
#                         return active_room
